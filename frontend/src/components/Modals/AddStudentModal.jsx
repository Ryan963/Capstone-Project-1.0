        ...
        <Modal.Body>
            <div>
                <div style={{width: '50%', display: "inline-block"}}>
                    <p>First Name: </p>
                    <input style={{outlineWidth: 1, outlineStyle: "solid", padding:2, width:280}} type="text"/>
                    ...
                    <input style={{outlineWidth: 1, outlineStyle: "solid", padding:2, width:280}} type="number"/>
                </div>
                <div style={{width: '50%', display: "inline-block"}}>
                    ...
                    <input style={{outlineWidth: 1, outlineStyle: "solid", padding:2, width:100}} type="number" id="currentYear" name="currentYear" min="1" max="4"/>
                    <p style={{paddingTop: 10}}>Current Master: </p>
                    <input style={{outlineWidth: 1, outlineStyle: "solid", padding:2, width:280}} type="text"/>
                    <p style={{paddingTop: 10}}>Graduated (T/F) :</p>
                    <select style={{outlineWidth: 1, outlineStyle: "solid", padding:2, width:100}}>
